...
$().ready( function() {
		...
		$.dialog({
			...
			onOk: function() {
				$.ajax({
					...
					type: "post",
					data: "_method=delete&"+$checkedIds.serialize(),
					dataType: "json",
					cache: false,
	...
	$.deleteRow = function(id) {
		$("#listTable input[name='ids']").attr("checked",false);
	...
	$closeButton.click( function() {
		var $this = $(this);
		var $popupMenu = $this.closest("div.popupMenu");
		$popupMenu.hide();
	...
	// 搜索选项
	$searchPropertySelect.click( function(event) {
		...
		var $menuWrap = $this.closest("div.menuWrap");
		var $popupMenu = $menuWrap.children("div.popupMenu");
		var $search = $menuWrap.children("div.search");

		$popupMenu.css({left: offset.left - $popupMenu.width()+$search.width()-1, top: offset.top + $this.height() + 2}).show();
